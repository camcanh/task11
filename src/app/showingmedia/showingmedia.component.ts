...
@Component({
  selector: 'app-showingmedia',
  templateUrl: './showingmedia.component.html',
  styleUrls: ['./showingmedia.component.css']
})
export class ShowingmediaComponent implements OnInit {
  private id: number;
